...
const sampleQuotes = [
  ...
  "Tehnologija je rije koja opisuje  ne funkcionira. - Douglas Adams",
  "Ne osnivate zajednice. Zajednice ve postoje. Pitanje koje treba postaviti je kako im moete pomoi da budu bolje.“ Mark Zuckerberg"
];
...
addNoteBtn.addEventListener("click", () => {
  ...
  note.textContent = "Napisati nešto";
  makeDraggable(note);
...
emailSend.addEventListener("click", () => {
    ...
    const subject = encodeURIComponent("Moj Vision Board");
    const body = encodeURIComponent(
        "Pozdrav,\n\nšaljem vam svoj Vision Board."
    );
